        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a href="{{route('home')}}"><i class="material-icons">dashboard</i> <span class="material-icon">Dashboard</span></a></li>
                    <li><a href="{{route('slider.index')}}"><i class="material-icons">dashboard</i> <span class="material-icon">Slider</span></a></li>
                    <li><a><i class="fa fa-home"></i> Department <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="javascript:void(0)">Computer</a></li>
                            <li><a href="javascript:void(0)">Electro Medical</a></li>
                            <li><a href="javascript:void(0)">Electronic</a></li>
                            ...
                            <li><a href="javascript:void(0)">RS Department</a></li>
                        </ul>
                    </li>
                    <li><a href="{{ route('teacher.index') }}"><i class="fa fa-laptop"></i> Teachers</a></li>
